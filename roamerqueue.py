...
if __name__ == "__main__":
    ...
    send_parser.add_argument('--block', action="store_true", help="Don't return immediately after enqueueing one or more samples. Instead wait until all samples are dumped by RoAMer. Meanwhile, RoAMer's logging is shown.")
    send_parser.add_argument('--first', action="store_true", help="Enqueue sample(s) at the beginning instead of the end of the queue")
